...
async function runMigration() {
  ...
  try {
    // 1. push_notification_schedules 테이블 생성
    console.log('[1/3] Creating push_notification_schedules table...');
    ...
    `);
    console.log('✅ push_notification_schedules created\n');

    // 2. push_notification_campaigns 테이블 생성
    console.log('[2/3] Creating push_notification_campaigns table...');
    await prisma.$executeRawUnsafe(`
    ...
    `);
    console.log('✅ push_notification_campaigns created\n');
