...
async function deleteAndInsertActivityTestData() {
  console.log('🗑️  기존 테스트 데이터 삭제 시작...');
  ...
  try {
    ...
    console.log('🚀 새로운 활동 테스트 데이터 삽입 시작...');

    // 2025-10-27 (일요일) - 3개 기록 (10분 단위)
    ...
    console.log('📊 총 7일간 23개의 활동 기록이 생성되었습니다 (모두 10분 단위).');
  } catch (error) {
...
deleteAndInsertActivityTestData();
