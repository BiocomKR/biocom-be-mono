 ...
 * 배송 운송장 등록 응답 DTO
 */
export class RegisterTrackingResponseDto extends SuccessResponseDto {
    trackingNumber: string;
}
 ...
 * 환불 승인 응답 DTO
 */
export class ApproveRefundResponseDto extends SuccessResponseDto {
    refundId: number;
}
 ...
 * 환불 거절 응답 DTO
 */
export class RejectRefundResponseDto extends SuccessResponseDto {
    refundId: number;
