...
export class ManagementChallengeController {
  ...
  constructor(private readonly challengeService: ManagementChallengeService) {}
   ...
   */
  @Get(':id/stats')
  async getChallengeStats(@Param('id', ParseIntPipe) productId: number) {
  ...
  async toggleChallengeStatus(@Param('id', ParseIntPipe) productId: number) {
