...
import { ManagementContentService, ContentType, ContentFileDto } from '../services/management-content.service';
...
export class ManagementContentController {
  ...
  constructor(private readonly contentService: ManagementContentService) {}
