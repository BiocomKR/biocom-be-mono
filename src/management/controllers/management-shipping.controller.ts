...
import {
  ManagementPaginatedResponseDto,
  ShippingListItemDto,
  RegisterTrackingResponseDto,
  ManagementSuccessResponseDto,
  BatchShippingResultDto,
  ManagementUnauthorizedResponseDto,
} from '../dto/management-response.dto';

@Controller('management/shipping')
@UseGuards(ApiKeyGuard)
export class ManagementShippingController {
  constructor(private readonly shippingService: ManagementShippingService) {}
