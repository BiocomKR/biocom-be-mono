...
export class RecordsController {
  ...
  async getRecords(
    ...
    return this.recordsService.getRecords(req.user.userId, { date, recordType });
  }
  ...
  async createBeautyRecord(
    ...
    return this.recordsService.createBeautyRecord(req.user.userId, createBeautyRecordDto);
  }
  ...
  async createDietRecord(
    ...
    return this.recordsService.createDietRecord(req.user.userId, createDietRecordDto);
  }
  ...
  async createSupplementRecord(
    ...
    return this.recordsService.createSupplementRecord(req.user.userId, createSupplementRecordDto);
  }
  ...
  async createFastingRecord(
    ...
    return this.recordsService.createFastingRecord(req.user.userId, createFastingRecordDto);
  }
  ...
  async createSleepRecord(
    ...
    return this.recordsService.createSleepRecord(req.user.userId, createSleepRecordDto);
  }
  ...
  async createActivityRecord(
    ...
    return this.recordsService.createActivityRecord(req.user.userId, createActivityRecordDto);
  }
